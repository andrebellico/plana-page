...
export default function Home() {
  return (
    ...
    >
      ...
      />
      <div className="max-[1238px]:translate-x-[25%] max-[678px]:translate-x-1/2 max-[410px]:translate-x-[20%] max-[470px]:translate-x-1/3 max-[470px]:-translate-y-1/3   max-[568px]:h-72  max-[568px]:py-12 max-[956px]:translate-x-3/4 max-[1238px]:-translate-y-3/4 max-[956px]:min-w-[200px] max-[1238px]:w-[300px] -translate-x-3/4 translate-y-10 bg-neutral-0  shadow-xl flex flex-col min-w-[563px] h-96 rounded-lg px-12 py-16">

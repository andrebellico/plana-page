...
export default function AboutSheSection() {
  return (
    <div id="Sobre" className="bg-neutral-0">
      <div className="max-w-[1352px] mx-auto  py-28 lg:px-36 md:px-20 sm:px-14 px-14 gap-36 flex-col sm:flex-col  lg:flex-row md:flex-col flex justify-center items-center ">
        <Image
          src={'/Alessandra.svg'}
          width={423}
          height={475}
